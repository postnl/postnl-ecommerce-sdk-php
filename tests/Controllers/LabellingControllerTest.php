...
class LabellingControllerTest extends BaseTestController
{
    /**
     * @var LabellingController LabellingController instance
     */
    ...
    {
        self::$controller = parent::getClient()->getLabellingController();
    }
    ...
    public function testGenerateLabel()
    {
        ...
        $result = null;
        try {
            $result = self::$controller->generateLabel($body, $confirm)->getResult();
