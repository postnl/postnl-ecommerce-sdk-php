...
class ConfirmingShipment implements \JsonSerializable
{
    /**
     * @var Address[]
     */
     ...
     * @maps Customs
     *
     * @param ConfirmingCustom[]|null $customs
     */
     ...
     * endpoints/send-track/confirming/guidelines) (Multiple shipments) for more information.
     *
     * @return Group[]|null
     */
    ...
    /**
     * Converts the ConfirmingShipment object to a human-readable string representation.
     *
     * @return string The string representation of the ConfirmingShipment object.
     */
