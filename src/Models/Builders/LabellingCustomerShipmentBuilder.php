...
use PostnlEcommerceLib\Models\Customs;
...
/**
 * Builder for model LabellingCustomerShipment
 *
 * @see LabellingCustomerShipment
 */
class LabellingCustomerShipmentBuilder
{
    /**
    ...
    private function __construct(LabellingCustomerShipment $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Labelling Customer Shipment Builder object.
     *
    ...
    public static function init(
        ...
        return new self(new LabellingCustomerShipment($addresses, $barcode, $dimension, $productCodeDelivery));
    }
     ...
     * Sets Customs field.
     *
     * @param Customs|null $value
     */
    public function customs(?Customs $value): self
    {
    ...
    /**
     * Initializes a new Labelling Customer Shipment object.
     */
    public function build(): LabellingCustomerShipment
    {
