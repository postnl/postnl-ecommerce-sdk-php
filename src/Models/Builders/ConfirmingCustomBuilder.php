...
/**
 * Builder for model ConfirmingCustom
 *
 * @see ConfirmingCustom
 */
class ConfirmingCustomBuilder
{
    /**
     * @var ConfirmingCustom
     */
    private $instance;

    private function __construct(ConfirmingCustom $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Confirming Custom Builder object.
     *
    ...
    {
        return new self(new ConfirmingCustom($currency, $shipmentType, $content));
    }
    ...
    /**
     * Initializes a new Confirming Custom object.
     */
    public function build(): ConfirmingCustom
    {
