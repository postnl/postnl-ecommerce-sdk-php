...
use PostnlEcommerceLib\Models\LabellingCustomerShipmentLabellingAPI;
use PostnlEcommerceLib\Models\ProductOption;

/**
 * Builder for model LabellingCustomerShipmentLabellingAPI
 *
 * @see LabellingCustomerShipmentLabellingAPI
 */
class LabellingCustomerShipmentLabellingAPIBuilder
{
    /**
     * @var LabellingCustomerShipmentLabellingAPI
     */
    private $instance;

    private function __construct(LabellingCustomerShipmentLabellingAPI $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Labelling Customer Shipment Labelling API Builder object.
     *
    ...
    public static function init(
        ...
        return new self(
            new LabellingCustomerShipmentLabellingAPI($addresses, $barcode, $dimension, $productCodeDelivery)
        );
    }
     ...
     * Sets Customs field.
     *
     * @param CustomsLabellingAPI|null $value
     */
    public function customs(?CustomsLabellingAPI $value): self
    {
    ...
    /**
     * Sets Extra Fields field.
     *
     * @param ExtraField[]|null $value
     */
    public function extraFields(?array $value): self
    {
        $this->instance->setExtraFields($value);
        return $this;
    }

    /**
     * Initializes a new Labelling Customer Shipment Labelling API object.
     */
    public function build(): LabellingCustomerShipmentLabellingAPI
    {
