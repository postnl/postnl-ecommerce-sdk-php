...
/**
 * Builder for model Customs
 *
 * @see Customs
 */
class CustomsBuilder
{
    /**
     * @var Customs
     */
    ...
    private function __construct(Customs $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Customs Builder object.
     *
    ...
    {
        return new self(new Customs($currency, $shipmentType, $content));
    }
    ...
    /**
     * Initializes a new Customs object.
     */
    public function build(): Customs
    {
