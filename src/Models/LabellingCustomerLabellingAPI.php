...
class LabellingCustomerLabellingAPI implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the LabellingCustomerLabellingAPI object to a human-readable string representation.
     *
     * @return string The string representation of the LabellingCustomerLabellingAPI object.
     */
