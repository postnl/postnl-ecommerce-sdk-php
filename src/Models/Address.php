...
class Address implements \JsonSerializable
{
     ...
     */
    public function __construct(string $addressType, string $countrycode)
    {
     ...
     * Type of the address. This is a code. You can find the possible values at [Address types](https:
     * //developer.postnl.nl/docs/#/http/reference-data/reference-codes/address-types)
     */
