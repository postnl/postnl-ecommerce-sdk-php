 ...
 */
class CustomsLabellingAPI implements \JsonSerializable
{
    /**
     * @var bool|null
     */
     ...
     * @required
     * @maps Currency
     * @factory \PostnlEcommerceLib\Models\CurrencyLabellingAPIEnum::checkValue
     */
     ...
     * 'Use only when available. Depending on the destination with this ID the customs process can be
     * faster. Only fill in this customs reference number if the sender is registrated as Trusted Shipper
     ...
     * Importer reference code. Fill in a Tax Code or VAT number or Importer code. Depending on the
     * destination with this reference the customs process can be faster.
     */
     ...
     * Code and accompanying description according to UPU Codelist 136. Codes to be used are shown below
     * for your reference. Or see the [Reference data](https://developer.postnl.nl/docs/#/http/reference-
     * data/reference-codes/transaction-codes).
     */
    ...
    /**
     * Returns Content.
     * The contents of the shipment. This section is mandatory (minimum once, maximum 5).
     *
     * @return LabellingCustomsContent[]
     */
    ...
    /**
     * Converts the CustomsLabellingAPI object to a human-readable string representation.
     *
     * @return string The string representation of the CustomsLabellingAPI object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        $json['Currency']                   = CurrencyLabellingAPIEnum::checkValue($this->currency);
