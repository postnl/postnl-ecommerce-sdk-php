...
class LabellingCustomerShipmentLabellingAPI implements \JsonSerializable
{
    /**
     * @var Address[]
     */
     ...
     */
    public function getCustoms(): ?CustomsLabellingAPI
    {
        return $this->customs;
    }
     ...
     * @maps Customs
     */
    public function setCustoms(?CustomsLabellingAPI $customs): void
    {
    ...
    /**
     * Converts the LabellingCustomerShipmentLabellingAPI object to a human-readable string representation.
     *
     * @return string The string representation of the LabellingCustomerShipmentLabellingAPI object.
     */
