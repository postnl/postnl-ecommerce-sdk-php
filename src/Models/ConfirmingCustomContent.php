...
class ConfirmingCustomContent implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * information](https://tarief.douane.nl/ite-tariff-public/#/home). Note: punctuation marks and symbols
     * are not allowed.
     */
    ...
    /**
     * Converts the ConfirmingCustomContent object to a human-readable string representation.
     *
     * @return string The string representation of the ConfirmingCustomContent object.
     */
