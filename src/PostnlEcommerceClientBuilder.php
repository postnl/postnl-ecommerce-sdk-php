...
class PostnlEcommerceClientBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * @see PostnlEcommerceClientBuilder::customHeaderAuthenticationCredentials
     *
    ...
    public function build(): PostnlEcommerceClient
    {
        return new PostnlEcommerceClient($this->config);
    }
}
