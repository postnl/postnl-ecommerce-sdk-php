...
class MethodNotAllowedOnlyGetPostException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MethodNotAllowedOnlyGetPostException object to a human-readable string representation.
     *
     * @return string The string representation of the MethodNotAllowedOnlyGetPostException object.
     */
