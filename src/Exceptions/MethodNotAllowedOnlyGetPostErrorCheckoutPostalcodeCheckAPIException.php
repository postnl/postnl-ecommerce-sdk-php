...
class MethodNotAllowedOnlyGetPostErrorCheckoutPostalcodeCheckAPIException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MethodNotAllowedOnlyGetPostErrorCheckoutPostalcodeCheckAPIException object to a human-
     * readable string representation.
     *
     * @return string The string representation of the MethodNotAllowedOnlyGetPostErrorCheckoutPostalcodeCheckAPIException object.
     */
