...
class MethodNotAllowedOnlyPostException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MethodNotAllowedOnlyPostException object to a human-readable string representation.
     *
     * @return string The string representation of the MethodNotAllowedOnlyPostException object.
     */
